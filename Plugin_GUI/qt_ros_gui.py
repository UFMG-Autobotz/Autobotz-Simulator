...
class Main_Window(QtGui.QMainWindow):
	...
	def controller_action(self,q):
		if q.text() == 'Nova aba':
			dock = QtGui.QDockWidget('Slider', self)
			dock.setWidget(Sliders_Window(self.slider_groups_file, dock))
	...
	def graph_Plotter_action(self,q):
		if q.text() == 'Nova aba':
			...
			dock.setWidget( Graphs_Window(dock))
			dock.setAllowedAreas(QtCore.Qt.TopDockWidgetArea)
			dock.setAttribute(QtCore.Qt.WA_DeleteOnClose)
			dock_title = DockTitleBar(dock)
			self.addDockWidget(QtCore.Qt.TopDockWidgetArea, dock)
	...
	def image_Viewer_action(self,q):
		if q.text() == 'Nova aba':
			dock = QtGui.QDockWidget('Image', self)
			dock.setWidget(Image_Window(dock))
			dock.setAllowedAreas(QtCore.Qt.TopDockWidgetArea)
			dock.setAttribute(QtCore.Qt.WA_DeleteOnClose)
			dock_title = DockTitleBar(dock)
			self.addDockWidget(QtCore.Qt.TopDockWidgetArea, dock)
